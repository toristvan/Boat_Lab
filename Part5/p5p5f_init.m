...
%plot zoomed psi for f and e
figure;
subplot(2,1,1);
hold on;
title({'Zoomed \psi with original Q_0 and Q_1.';'Current and wave disturbance'});
plot(t, psi_ref*ones(5000,1),'--r');
plot(t,psi_m_e,'--',t, psi_est_e);
plot(t,psi_m_e_f_1,'--',t,psi_est_e_f_1);
xlabel('$Time [s]$', 'Interpreter', 'latex');
...
subplot(2,1,2);
hold on;
title({'Zoomed \psi with original Q_0 and Q_2.';'Current and wave disturbance'});
plot(t, psi_ref*ones(5000,1),'--r');
plot(t,psi_m_e,'--',t, psi_est_e);
plot(t,psi_m_e_f_2,'--',t,psi_est_e_f_2);
xlabel('$Time [s]$', 'Interpreter', 'latex');
...
%plot zoomed delta for f and e
figure;
subplot(2,1,1);
hold on;
title({'Zoomed \delta with original Q_0 and Q_1.';'Current and wave disturbance'});
plot(t,delta_m_e,'--', t, bias_est_e);
plot(t,delta_m_e_f_1,'--',t,bias_est_e_f_1);
xlabel('$Time [s]$', 'Interpreter', 'latex');
ylabel('$Angle [deg]$', 'Interpreter', 'latex');
...
subplot(2,1,2);
hold on;
title({'Zoomed \delta with original Q_0 and Q_2.';'Current and wave disturbance'});
plot(t,delta_m_e,'--', t, bias_est_e);
plot(t,delta_m_e_f_2,'--',t,bias_est_e_f_2);
xlabel('$Time [s]$', 'Interpreter', 'latex');
ylabel('$Angle [deg]$', 'Interpreter', 'latex');
